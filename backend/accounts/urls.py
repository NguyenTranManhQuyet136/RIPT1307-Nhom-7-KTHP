...
from .views import RegisterView, CustomTokenObtainPairView, ForgotPasswordView, ResetPasswordView, UserProfileUpdateView, UnverifiedLecturersListView, VerifyLecturerView
